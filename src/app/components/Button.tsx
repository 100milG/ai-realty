...
interface ButtonProps extends Omit<HTMLMotionProps<"button">, "size"> {
  variant?: "primary" | "secondary" | "outline" | "ghost" | "success" | "accent" | "destructive";
  size?: "sm" | "md" | "lg";
  children: ReactNode;
}
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses = {
      ...
      destructive:
        "bg-red-600 text-white hover:bg-red-700 active:bg-red-800 shadow-soft hover:shadow-elevated dark:bg-red-500 dark:hover:bg-red-600 dark:active:bg-red-700",
    };
